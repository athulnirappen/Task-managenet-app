  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm border rounded-xl px-8 py-9">
        <h1 className="text-2xl font-semibold text-black mb-1.5">Register</h1>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="mb-4">
            ...
            />
            {fieldErrors.name && (
              <p className="text-[#e5637a] text-xs mt-1">{fieldErrors.name}</p>
            )}
          </div>
          ...
          <div className="mb-4">
            ...
            />
            {fieldErrors.password && (
              <p className="text-[#e5637a] text-xs mt-1">
                {fieldErrors.password}
              </p>
            )}
          </div>
        ...
        <div className="mt-5 text-sm text-[#9a9da8] text-center">
          ...
          <Link to="/" className="text-[#5b8def] hover:underline">
            Log in
          </Link>
        </div>
      </div>
